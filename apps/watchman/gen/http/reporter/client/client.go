...
//
// reporter client HTTP transport
//
// Command:
...
// Client lists the reporter service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the reporter service servers.
func NewClient(
	scheme string,
	host string,
	doer goahttp.Doer,
...
// Add returns an endpoint that makes HTTP requests to the reporter service add
// server.
