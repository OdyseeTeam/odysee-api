...
// Server lists the playback service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Add    http.Handler
}
...
// New instantiates HTTP handlers for all the playback service endpoints using
...
func (s *Server) Service() string { return "playback" }
...
// Mount configures the mux to serve the playback endpoints.
...
// MountAddHandler configures the mux to serve the "playback" service "add"
// endpoint.
...
func NewAddHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "playback")
