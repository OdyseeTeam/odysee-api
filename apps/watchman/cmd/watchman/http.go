...
func handleHTTPServer(ctx context.Context, addr string, reporterEndpoints *reporter.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
