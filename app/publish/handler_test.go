...
func TestUploadHandler(t *testing.T) {
	...
	expectedPath := path.Join(os.TempDir(), "20404", "lbry_auto_test_file_.+")
...
func Test_fetchFile(t *testing.T) {
	...
	cases := []struct {
		...
		{fmt.Sprintf("%v/1Mb.dat", ts.URL), ".+/20404/1Mb.dat_.+$", 125000},
		{fmt.Sprintf("%v/../../../../../etc/passwd", ts.URL), ".+/20404/passwd_.+$", 1},
	}
