...
// func newTestHandlerWithOauth(t *testing.T, reqChan chan *test.Request) *Handler {
// 	if reqChan == nil {
...
// func newTestMux(h *Handler, mwf ...mux.MiddlewareFunc) *mux.Router {
...
// func newPartialUpload(t *testing.T, h *Handler, headers ...header) string {
// 	t.Helper()
...
// func newFinalUpload(t *testing.T, h *Handler, headers ...header) string {
...
// 		name   string
// 		optsFn func() []func(*HandlerOptions)
// 	}{
// 		{
...
// 		h := newTestHandlerWithOauth(t, nil)
// 		w := httptest.NewRecorder()
...
// 		reqChan := test.ReqChan()
// 		h := newTestHandlerWithOauth(t, reqChan)
// 		w := httptest.NewRecorder()
