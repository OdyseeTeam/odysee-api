...
var testSDHash = "bea4d30a1868a00e98297cfe8cdefc1be6c141b54bea3b7c95b34a66786c22ab4e9f35ae19aa453b3630e76afbd24fe2"
...
func TestCreateToken(t *testing.T) {
	size := mrand.Uint64()
	token, err := CreateToken(testSDHash, testTxID, size, ExpTenSecPer100MB)
	require.NoError(t, err)

	streamToken, err := km.PublicKeyManager().ValidateToken(token)
	require.NoError(t, err)
	assert.Equal(t, streamToken.SDHash, testSDHash)
